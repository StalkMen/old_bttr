...
///////////////////////////////////////////////////////////////////////////////
    ...
    #define BOOST_SPIRIT_DEBUG_RULE(r)    \
        ::boost_cryray::spirit::impl::get_node_registry().register_node(&r, #r, BOOST_SPIRIT_DEBUG_TRACENODE)
    ...
    #define BOOST_SPIRIT_DEBUG_TRACE_RULE(r, t)    \
        ::boost_cryray::spirit::impl::get_node_registry().register_node(&r, #r, (t))
    ...
    #define BOOST_SPIRIT_DEBUG_TRACE_RULE_NAME(r, n, t)    \
        ::boost_cryray::spirit::impl::get_node_registry().register_node(&r, (n), (t))

...
struct equal_to
{
    ...
    BOOST_MPL_AUX_LAMBDA_SUPPORT(2,equal_to,(T1,T2))
};

BOOST_MPL_AUX_VOID_SPEC(2, equal_to)
...
#if !defined(__BORLANDC__)
        : equal_to< T,integral_c<long,N> >
    {
#else
    {
        typedef typename equal_to< T,integral_c<long,N> >::type type;
#endif
    };
};

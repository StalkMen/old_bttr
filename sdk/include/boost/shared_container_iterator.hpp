...
struct shared_container_iterator_policies :
  ...
  typedef boost_cryray::shared_ptr<Container> container_ref_t;
...
public:
  typedef boost_cryray::iterator_adaptor<iterator,policy> type;
};

template <typename Container>
typename shared_container_iterator_generator<Container>::type
make_shared_container_iterator(typename Container::iterator iter,
			       boost_cryray::shared_ptr<Container> const& container) {
...
std::pair<
  typename shared_container_iterator_generator<Container>::type,
  typename shared_container_iterator_generator<Container>::type>
make_shared_container_range(boost_cryray::shared_ptr<Container> const& container) {
  return
    std::make_pair(

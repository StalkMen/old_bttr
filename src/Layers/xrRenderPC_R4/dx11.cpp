...
void					CRender::create					()
{
	...
	Msg("~ DX11: Information about MSAA with xrEngine, selected token: %i", ps_r3_msaa);
	Msg("~ DX11: Information about MSAA A-Test with xrEngine, selected token: %i", ps_r3_msaa_atest);

	Msg("~ DX11: Information about 'Sun Quality' with xrEngine, selected token: %i", ps_r_sun_quality);

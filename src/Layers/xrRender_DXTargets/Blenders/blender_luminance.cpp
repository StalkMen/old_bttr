...
BLENDER::CBlender_luminance::CBlender_luminance	()	{	description.CLS		= 0;	}
BLENDER::CBlender_luminance::~CBlender_luminance	()	{	}

void	BLENDER::CBlender_luminance::Compile(CBlender_Compile& C)
{
	IBlender::Compile	(C);

...
BLENDER::CBlender_accum_direct::CBlender_accum_direct	()	{ description.CLS		= 0;	}
BLENDER::CBlender_accum_direct::~CBlender_accum_direct	()	{	}

void	BLENDER::CBlender_accum_direct::Compile(CBlender_Compile& C)
{
	IBlender::Compile		(C);
...
BLENDER::CBlender_accum_direct_msaa::CBlender_accum_direct_msaa	()	{		Name = 0; Definition = 0; description.CLS		= 0;	}
BLENDER::CBlender_accum_direct_msaa::~CBlender_accum_direct_msaa	()	{	}

//	TODO: DX10:	implement CBlender_accum_direct::Compile
void	BLENDER::CBlender_accum_direct_msaa::Compile(CBlender_Compile& C)
{
	IBlender::Compile		(C);
...
BLENDER::CBlender_accum_direct_volumetric_msaa::~CBlender_accum_direct_volumetric_msaa	()	{	}

//	TODO: DX10:	implement CBlender_accum_direct::Compile
void	BLENDER::CBlender_accum_direct_volumetric_msaa::Compile(CBlender_Compile& C)
{
	IBlender::Compile		(C);
...
BLENDER::CBlender_accum_direct_volumetric_sun_msaa::~CBlender_accum_direct_volumetric_sun_msaa	()	{	}

//	TODO: DX10:	implement CBlender_accum_direct::Compile
void	BLENDER::CBlender_accum_direct_volumetric_sun_msaa::Compile(CBlender_Compile& C)
{
	IBlender::Compile		(C);

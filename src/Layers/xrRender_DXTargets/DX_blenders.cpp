...
{	
	switch (cls)
	{
	case B_DEFAULT:			return xr_new<BLENDER::CBlender_deffer_flat>		();
	case B_DEFAULT_AREF:	return xr_new<BLENDER::CBlender_deffer_aref>		(true);
	case B_VERT:			return xr_new<BLENDER::CBlender_deffer_flat>		();
	case B_VERT_AREF:		return xr_new<BLENDER::CBlender_deffer_aref>		(false);
	...
	case B_MODEL:			return xr_new<BLENDER::CBlender_deffer_model>	();

...
//		g_accum_point_vb->Unlock	();
...
#ifdef DIRECTX10
		DEVICE_HW::CRYRAY_RENDER::HW.stats_manager.increment_stats_vb			( g_accum_point_vb );
#endif		
	}
	...
	// Indices
	{
		...
		//BYTE*	pData		= 0;
		//R_CHK				(DEVICE_HW::CRYRAY_RENDER::HW.pDevice->CreateIndexBuffer(iCount*2,dwUsage,D3DFMT_INDEX16,D3DPOOL_MANAGED,&g_accum_point_ib,0));
...
#ifdef DIRECTX10
		DEVICE_HW::CRYRAY_RENDER::HW.stats_manager.increment_stats_ib			( g_accum_point_ib );
#endif
	}
}
...
#endif // DEBUG
#ifdef DIRECTX10
	DEVICE_HW::CRYRAY_RENDER::HW.stats_manager.decrement_stats_ib(g_accum_point_ib);
#endif	
...
#endif // DEBUG
#ifdef DIRECTX10
	DEVICE_HW::CRYRAY_RENDER::HW.stats_manager.decrement_stats_vb(g_accum_point_vb);
#endif	

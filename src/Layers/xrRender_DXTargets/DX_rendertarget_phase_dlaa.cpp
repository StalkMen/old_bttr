...
void CRenderTarget::phase_dlaa()
{
	...
	// Set RT's
	u_setrt(rt_Generic, nullptr, nullptr, DEVICE_HW::CRYRAY_RENDER::HW.pBaseZB);
	...
	DEVICE_HW::CRYRAY_RENDER::HW.pRenderContext->CopyResource(rt_Generic_0->pTexture->surface_get(), rt_Generic->pTexture->surface_get());
};

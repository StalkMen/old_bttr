...
//	u32	dwUsage				= D3DUSAGE_WRITEONLY;
...
#ifdef DIRECTX10
		DEVICE_HW::CRYRAY_RENDER::HW.stats_manager.increment_stats_vb			( g_accum_spot_vb );
#endif
	}
	...
	// Indices
	{
		...
		//BYTE*	pData		= 0;
		//R_CHK				(DEVICE_HW::CRYRAY_RENDER::HW.pDevice->CreateIndexBuffer(iCount*2,dwUsage,D3DFMT_INDEX16,D3DPOOL_MANAGED,&g_accum_spot_ib,0));
...
#ifdef DIRECTX10	
		DEVICE_HW::CRYRAY_RENDER::HW.stats_manager.increment_stats_ib			( g_accum_spot_ib );
#endif														
	}
}
...
#endif // DEBUG
#ifdef DIRECTX10	
	DEVICE_HW::CRYRAY_RENDER::HW.stats_manager.decrement_stats_ib	(g_accum_spot_ib);
#endif	
...
#endif // DEBUG
#ifdef DIRECTX10	
	DEVICE_HW::CRYRAY_RENDER::HW.stats_manager.decrement_stats_vb	(g_accum_spot_vb);
#endif
...
void CRenderTarget::accum_volumetric_geom_create()
{
...
#ifdef DIRECTX10
		DEVICE_HW::CRYRAY_RENDER::HW.stats_manager.increment_stats_vb			( g_accum_volumetric_vb );	
#endif		
	}
	...
	// Indices
	{
		...
		//BYTE*	pData		= 0;
		//R_CHK				(DEVICE_HW::CRYRAY_RENDER::HW.pDevice->CreateIndexBuffer(iCount*2,dwUsage,D3DFMT_INDEX16,D3DPOOL_MANAGED,&g_accum_volumetric_ib,0));
...
#ifdef DIRECTX10
		DEVICE_HW::CRYRAY_RENDER::HW.stats_manager.increment_stats_ib			(g_accum_volumetric_ib);
#endif																
...
#endif // DEBUG
#ifdef DIRECTX10
	DEVICE_HW::CRYRAY_RENDER::HW.stats_manager.decrement_stats_ib(g_accum_volumetric_ib);
#endif															
...
#endif // DEBUG
#ifdef DIRECTX10
	DEVICE_HW::CRYRAY_RENDER::HW.stats_manager.decrement_stats_vb(g_accum_volumetric_vb);
#endif															

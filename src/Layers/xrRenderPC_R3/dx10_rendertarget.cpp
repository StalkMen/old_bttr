...
#include "blenders_DX10/blender_light_occq.h"
#include "blenders_DX10/blender_light_mask.h"
#include "blenders_DX10/blender_light_direct.h"
#include "blenders_DX10/blender_light_point.h"
#include "blenders_DX10/blender_light_spot.h"
#include "blenders_DX10/blender_light_reflected.h"
#include "blenders_DX10/blender_combine.h"
#include "blenders_DX10/blender_bloom_build.h"
#include "blenders_DX10/blender_luminance.h"
   ...
   if( RImplementation.o.dx10_msaa )
   {
	...
	// TONEMAP
	{
		...
		for (u32 it=0; it<HW.Caps.iGPUNum*2; it++)	{
			...
			HW.pRenderDevice->ClearRenderTargetView(rt_LUM_pool[it]->pRT, ColorRGBA);
		}
	...
	// Build textures
	{
		...
		if (1)
		{
			...
			//	Create noise mipped
			{
				...
				HW.pRenderDevice->CopySubresourceRegion( t_noise_surf_mipped, 0, 0, 0, 0, t_noise_surf[0], 0, 0 );

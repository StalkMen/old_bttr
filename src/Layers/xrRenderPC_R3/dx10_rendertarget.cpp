...
#include "../xrRenderPC_R3/blenders_DX10/blender_light_occq.h"
#include "../xrRenderPC_R3/blenders_DX10/blender_light_mask.h"
#include "../xrRenderPC_R3/blenders_DX10/blender_light_direct.h"
#include "../xrRenderPC_R3/blenders_DX10/blender_light_point.h"
#include "../xrRenderPC_R3/blenders_DX10/blender_light_spot.h"
#include "../xrRenderPC_R3/blenders_DX10/blender_light_reflected.h"
#include "../xrRenderPC_R3/blenders_DX10/blender_combine.h"
   ...
   if( RImplementation.o.dx10_gbuffer_opt )
	...
	//	NORMAL
	{
      ...
      if( !RImplementation.o.dx10_gbuffer_opt )
		...
		rt_Generic.create		(r2_RT_generic,w,h,D3DFMT_A8R8G8B8, 1		); //Pingpong	

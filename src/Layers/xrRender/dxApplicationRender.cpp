...
{
	ZeroMemory(&DEVICE_HW::CRYRAY_RENDER::HW,sizeof(DEVICE_HW::CRYRAY_RENDER::CHW));
}
...
#else	//	DIRECTX10
	CHK_DX			(DEVICE_HW::CRYRAY_RENDER::HW.pDevice->Clear(0,0,D3DCLEAR_TARGET,D3DCOLOR_ARGB(0,0,0,0),1,0));
#endif	//	DIRECTX10
...
//	DEVICE_HW::CRYRAY_RENDER::HW.pContext->ClearRenderTargetView( RCache.get_RT(), ColorRGBA);
//	DEVICE_HW::CRYRAY_RENDER::HW.pContext->ClearDepthStencilView( RCache.get_ZB(), D3D_CLEAR_DEPTH|D3D_CLEAR_STENCIL, 1.0f, 0);
#endif	//	DIRECTX10

...
{
	CHK_DX(DEVICE_HW::CRYRAY_RENDER::HW.pRenderDevice->CreateRasterizerState( &desc, ppIState));
...
{
	CHK_DX(DEVICE_HW::CRYRAY_RENDER::HW.pRenderDevice->CreateDepthStencilState( &desc, ppIState));
...
{
	CHK_DX(DEVICE_HW::CRYRAY_RENDER::HW.pRenderDevice->CreateBlendState( &desc, ppIState));

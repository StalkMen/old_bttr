...
{
	CHK_DX(HW.pRenderDevice->CreateSamplerState( &desc, ppIState));
}
...
void dx10SamplerStateCache::VSApplySamplers(HArray &samplers)
{
	...
	HW.pRenderContext->VSSetSamplers(uiMin, uiMax-uiMin+1, &pSS[uiMin]);
}
...
void dx10SamplerStateCache::PSApplySamplers(HArray &samplers)
{
	...
	HW.pRenderContext->PSSetSamplers(uiMin, uiMax-uiMin+1, &pSS[uiMin]);
}
...
void dx10SamplerStateCache::GSApplySamplers(HArray &samplers)
{
	...
	HW.pRenderContext->GSSetSamplers(uiMin, uiMax-uiMin+1, &pSS[uiMin]);
}
...
void dx10SamplerStateCache::HSApplySamplers(HArray &samplers)
{
	...
	HW.pRenderContext->HSSetSamplers(uiMin, uiMax-uiMin+1, &pSS[uiMin]);
}
...
void dx10SamplerStateCache::DSApplySamplers(HArray &samplers)
{
	...
	HW.pRenderContext->DSSetSamplers(uiMin, uiMax-uiMin+1, &pSS[uiMin]);
}
...
void dx10SamplerStateCache::CSApplySamplers(HArray &samplers)
{
	...
	HW.pRenderContext->CSSetSamplers(uiMin, uiMax-uiMin+1, &pSS[uiMin]);
}
#endif

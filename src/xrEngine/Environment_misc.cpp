...
#pragma TODO("OldSerpskiStalker. Vanilla Call Of Chernobyl")
    env_ambient = config.line_exist(m_identifier.c_str(), (Call_of_Chernobyl_mode) ? "ambient" : "env_ambient") ? environment.AppendEnvAmb(config.r_string(m_identifier.c_str(), (Call_of_Chernobyl_mode) ? "ambient" : "env_ambient")) : 0;

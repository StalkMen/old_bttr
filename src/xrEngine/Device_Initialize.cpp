...
PROTECT_API void CRenderDevice::Initialize()
{
    ...
    if (m_hWnd == NULL)
    {
        LPCSTR	wndclass = "Engine_x64_1_4_22";
        ...
        m_hWnd = CreateWindowEx(WS_EX_TOPMOST, wndclass, "S.T.A.L.K.E.R.: Call of Chernobyl (TouchOfRay Engine)", m_dwWindowStyle, 0, 0, screen_width, screen_height, 0L, 0, hInstance, 0L);
}

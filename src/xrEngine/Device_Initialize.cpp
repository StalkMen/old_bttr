...
PROTECT_API void CRenderDevice::Initialize()
{
    ...
    if (m_hWnd == NULL)
    {
        ...
        m_hWnd = CreateWindowEx(WS_EX_TOPMOST, wndclass, "S.T.A.L.K.E.R.: Call of Chernobyl (CryRay Engine)", m_dwWindowStyle, 0, 0, screen_width, screen_height, 0L, 0, hInstance, 0L);
    }

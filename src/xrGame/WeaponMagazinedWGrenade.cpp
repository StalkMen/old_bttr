...
float zoom_mbGrenadeMode = 130.0f;
...
{
    if (m_bGrenadeMode)
        PlayHUDMotion("anm_switch_g", TRUE, this, eSwitch); //AVO: fix fast anim switch
    else
        PlayHUDMotion("anm_switch", TRUE, this, eSwitch); //AVO: fix fast anim switch
}

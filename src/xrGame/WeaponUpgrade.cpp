...
bool CWeapon::install_upgrade_disp(LPCSTR section, bool test)
{
    ...
    bool result2 = process_if_exists_set(section, "zoom_enabled", &CInifile::r_bool_m, value, test);
    if (result2 && !test)
    {
...
bool CWeapon::install_upgrade_addon(LPCSTR section, bool test)
{
    ...
    result |= process_if_exists_set(section, "scope_dynamic_zoom", &CInifile::r_bool_m, m_zoom_params.m_bUseDynamicZoom, test);

...
//		.def("set_sight",					(void (CScriptGameObject::*)(const MemorySpace::CMemoryInfo *memory_object, bool	torso_look))(&CScriptGameObject::set_sight))
        ...
        .def("get_artefact_artefact_reaction", &CScriptGameObject::GetArtefactArtefReactionRestoreSpeed)

        .def("set_artefact_artefact_reaction", &CScriptGameObject::SetArtefactArtefReactionRestoreSpeed)

...
CPseudoGigant_jumperStepEffector::CPseudoGigant_jumperStepEffector(float time, float amp, float periods, float power) 
...
BOOL CPseudoGigant_jumperStepEffector::ProcessCam(SCamEffectorInfo& info)
{

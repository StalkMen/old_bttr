...
#define CStateBloodsuckcsPredatorLiteAbstract CStateBloodsuckcsPredatorLite<_Object>

template <typename _Object>
CStateBloodsuckcsPredatorLiteAbstract::CStateBloodsuckcsPredatorLite(_Object *obj) : inherited(obj)
{
...
template <typename _Object>
void CStateBloodsuckcsPredatorLiteAbstract::reinit()
{
	inherited::reinit	();
}

template <typename _Object>
void CStateBloodsuckcsPredatorLiteAbstract::initialize()
{
...
template <typename _Object>
void CStateBloodsuckcsPredatorLiteAbstract::reselect_state()
{
...
template <typename _Object>
void CStateBloodsuckcsPredatorLiteAbstract::finalize()
{
	inherited::finalize							();
...
template <typename _Object>
void CStateBloodsuckcsPredatorLiteAbstract::critical_finalize()
{
...
template <typename _Object>
bool CStateBloodsuckcsPredatorLiteAbstract::check_completion()
{
...
template <typename _Object>
void CStateBloodsuckcsPredatorLiteAbstract::setup_substates()
{
...
template <typename _Object>
void CStateBloodsuckcsPredatorLiteAbstract::check_force_state()
{
	if (prev_substate == eStatePredator_Camp) {
...
template <typename _Object>
void CStateBloodsuckcsPredatorLiteAbstract::select_camp_point()
{
	if (m_target_node != u32(-1)) 
		monster_squad().get_squad(object)->unlock_cover(m_target_node);
...
template <typename _Object>
bool CStateBloodsuckcsPredatorLiteAbstract::enemy_see_me()
{
	return object->EnemyMan.enemy_see_me_now();
}

#undef CStateBloodsuckcsPredatorLiteAbstract

...
#define CStateBloodsuckcsPredatorAbstract CStateBloodsuckcsPredator<_Object>

template <typename _Object>
CStateBloodsuckcsPredatorAbstract::CStateBloodsuckcsPredator(_Object *obj) : inherited(obj)
{
...
template <typename _Object>
void CStateBloodsuckcsPredatorAbstract::reinit()
{
	inherited::reinit	();
}

template <typename _Object>
void CStateBloodsuckcsPredatorAbstract::initialize()
{
...
template <typename _Object>
void CStateBloodsuckcsPredatorAbstract::reselect_state()
{
...
template <typename _Object>
void CStateBloodsuckcsPredatorAbstract::finalize()
{
	inherited::finalize							();
...
template <typename _Object>
void CStateBloodsuckcsPredatorAbstract::critical_finalize()
{
...
template <typename _Object>
bool CStateBloodsuckcsPredatorAbstract::check_start_conditions()
{
...
template <typename _Object>
bool CStateBloodsuckcsPredatorAbstract::check_completion()
{
...
template <typename _Object>
void CStateBloodsuckcsPredatorAbstract::setup_substates()
{
...
template <typename _Object>
void CStateBloodsuckcsPredatorAbstract::check_force_state()
{
...
template <typename _Object>
void CStateBloodsuckcsPredatorAbstract::select_camp_point()
{
	m_target_node = u32(-1);
...
#undef CStateBloodsuckcsPredatorAbstract

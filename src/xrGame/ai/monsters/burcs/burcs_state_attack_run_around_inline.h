...
#define CStateBurcsAttackRunAroundAbstract CStateBurcsAttackRunAround<_Object>
...
CStateBurcsAttackRunAroundAbstract::CStateBurcsAttackRunAround(_Object *obj) : inherited(obj)
{
}

template <typename _Object>
void CStateBurcsAttackRunAroundAbstract::initialize()
{
...
template <typename _Object>
void CStateBurcsAttackRunAroundAbstract::execute()
{
...
template <typename _Object>
bool CStateBurcsAttackRunAroundAbstract::check_start_conditions()
{
	return true;
}

template <typename _Object>
bool CStateBurcsAttackRunAroundAbstract::check_completion()
{
...
#undef CStateBurcsAttackRunAroundAbstract

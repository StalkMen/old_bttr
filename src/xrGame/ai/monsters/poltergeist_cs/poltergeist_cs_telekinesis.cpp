...
CPolterTele_cs::CPolterTele_cs(CPoltergeist_cs *polter) : inherited (polter)
{
}

CPolterTele_cs::~CPolterTele_cs()
{
}

void CPolterTele_cs::load(LPCSTR section)
{
...
void CPolterTele_cs::update_schedule()
{
...
void CPolterTele_cs::tele_fire_objects()
{

...
CPolterFlame_cs::CPolterFlame_cs(CPoltergeist_cs *polter) : inherited (polter)
{
}

CPolterFlame_cs::~CPolterFlame_cs()
{
}

void CPolterFlame_cs::load(LPCSTR section) 
{
...
void CPolterFlame_cs::select_state(SFlameElement *elem, EFlameState state)
{
	elem->state			= state;
...
struct remove_predicate {
	bool	operator() (CPolterFlame_cs::SFlameElement *element)	{
		return (!element);
	}
};


void CPolterFlame_cs::update_schedule()
{
...
void CPolterFlame_cs::on_destroy()
{

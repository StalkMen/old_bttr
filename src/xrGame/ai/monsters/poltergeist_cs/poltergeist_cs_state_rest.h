...
class	CPoltergeist_csStateRest : public CStateMonsterRest<_Object> {
protected:
	typedef CStateMonsterRest<_Object>		inherited;
public:
						CPoltergeist_csStateRest		(_Object *obj) : inherited(obj) {}
	virtual	void		execute					();
};

template<typename _Object>
void CPoltergeist_csStateRest<_Object>::execute()
{
	// check alife control

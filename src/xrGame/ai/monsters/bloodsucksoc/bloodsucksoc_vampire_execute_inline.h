...
#define CStateBloodsuckerVampireExecuteAbstract CStateBloodsucksocVampireExecute<_Object>
...
void CStateBloodsuckerVampireExecuteAbstract::execute_vampire_prepare()
{
    ...
    this->object->sound().play(CAI_Bloodsucksoc::eVampireGrasp);
}
...
void CStateBloodsuckerVampireExecuteAbstract::execute_vampire_continue()
{
    ...
    this->object->sound().play(CAI_Bloodsucksoc::eVampireSucking);
...
void CStateBloodsuckerVampireExecuteAbstract::execute_vampire_hit()
{
    ...
    this->object->sound().play(CAI_Bloodsucksoc::eVampireHit);

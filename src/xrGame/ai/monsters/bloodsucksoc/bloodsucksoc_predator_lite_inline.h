...
#define CStateBloodsucksocPredatorLiteAbstract CStateBloodsucksocPredatorLite<_Object>

template <typename _Object>
CStateBloodsucksocPredatorLiteAbstract::CStateBloodsucksocPredatorLite(_Object *obj) : inherited(obj)
{
...
template <typename _Object>
void CStateBloodsucksocPredatorLiteAbstract::reinit()
{
	inherited::reinit	();
}

template <typename _Object>
void CStateBloodsucksocPredatorLiteAbstract::initialize()
{
...
template <typename _Object>
void CStateBloodsucksocPredatorLiteAbstract::reselect_state()
{
...
template <typename _Object>
void CStateBloodsucksocPredatorLiteAbstract::finalize()
{
	inherited::finalize							();
...
template <typename _Object>
void CStateBloodsucksocPredatorLiteAbstract::critical_finalize()
{
...
template <typename _Object>
bool CStateBloodsucksocPredatorLiteAbstract::check_completion()
{
...
template <typename _Object>
void CStateBloodsucksocPredatorLiteAbstract::setup_substates()
{
...
template <typename _Object>
void CStateBloodsucksocPredatorLiteAbstract::check_force_state()
{
	if (prev_substate == eStatePredator_Camp) {
...
template <typename _Object>
void CStateBloodsucksocPredatorLiteAbstract::select_camp_point()
{
	if (m_target_node != u32(-1)) 
		monster_squad().get_squad(object)->unlock_cover(m_target_node);
...
template <typename _Object>
bool CStateBloodsucksocPredatorLiteAbstract::enemy_see_me()
{
...
#undef CStateBloodsucksocPredatorLiteAbstract

...
CVampirePPEffectsocor::CVampirePPEffectsocor(const SPPInfo& ppi, float life_time)
...
BOOL CVampirePPEffectsocor::Process(SPPInfo& pp)
{
...
BOOL CVampireCameraEffectorsoc::ProcessCam(SCamEffectorInfo& info)
{

...
#define CBloodsucksocStateAttackAbstract CBloodsucksocStateAttack<_Object>
...
template <typename _Object>
CBloodsucksocStateAttackAbstract::~CBloodsucksocStateAttack()
{
}

template <typename _Object>
void CBloodsucksocStateAttackAbstract::initialize()
{
...
template <typename _Object>
void CBloodsucksocStateAttackAbstract::finalize()
{
	inherited::finalize();
...
template <typename _Object>
void CBloodsucksocStateAttackAbstract::critical_finalize()
{
...
template <typename _Object>
void CBloodsucksocStateAttackAbstract::execute()
{
	bool selected = false;
...
template <typename _Object>
bool CBloodsucksocStateAttackAbstract::check_vampire()
{
...
template <typename _Object>
void CBloodsucksocStateAttackAbstract::update_invisibility()
{
...
template <typename _Object>
bool CBloodsucksocStateAttackAbstract::check_hiding()
{
	if (current_substate == eStateAttack_Hide) 
...
template <typename _Object>
void CBloodsucksocStateAttackAbstract::setup_substates()
{
...
#undef CBloodsucksocStateAttackAbstract

...
class CAI_Bloodsucksoc : public CBaseMonster, 
...
private:
	...
	//--------------------------------------------------------------------
public:
	CBloodsucksocAlien		m_alien_control;
	u32						m_time_lunge;
...
public:
			...
			virtual	char* get_monster_class_name() { return "bloodsucksoc"; }
...
add_to_type_list(CAI_Bloodsucksoc)
#undef script_type_list
#define script_type_list save_type_list(CAI_Bloodsucksoc)
...
#define CLSID_AI_BLOODSUCKSOC		MK_CLSID('A','I','_','B','L','O','D','S')
#define CLSID_AI_BLOODSUCKCS		MK_CLSID('A','I','_','B','L','O','D','C')
...
#define CLSID_AI_GIANJ				MK_CLSID('A','I','_','G','I','A','N','J')
...
#define CLSID_AI_DOG_SOC			MK_CLSID('A','I','_','D','O','G','_','S')
...
#define CLSID_IITEM_DETECTOR		MK_CLSID('I','I','_','D','E','T','E','C')
